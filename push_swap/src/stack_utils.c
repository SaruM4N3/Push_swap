...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/18 16:07:16 by marvin            #+#    #+#             */
/*   Updated: 2025/03/18 16:07:16 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	stack_sorted(t_stack_node *stack) //Define a function that checks if the stack is sorted in ascending order
{
	...
	while (stack->next) //Loop until the end of the stack is reached
	{
		if (stack->value > stack->next->value) //Check if the current value is larger than the next node's value, indicating it is out of sort
			return (false);
