...
NUL).  This keeps strlcat() from running off the end of a string.  In prac‐
tice this should not happen (as it means that either size is  incorrect  or
that  dst  is not a proper “C” string).  The check exists to prevent poten‐
